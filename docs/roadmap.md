...
|---|---|---|---|
| nenhuma ainda | — | Sprint 34 (30 + 4), adiada | 6/5 sprints completadas (Sprint 30, Sprint 31, Sprint 32, Sprint 33, Sprint 34, Sprint 35); mecanismo criado na Sprint 29. **Checkpoint da Sprint 34 (2026-08-21):** CTO propôs rodar `structural-auditor` antes do redesign visual do E10 (ADR-003 cita troca de sistema de design como o cenário que a auditoria existe para pegar) — **CEO decidiu adiar**, não reabrir sem pedido explícito dele. Sprint 35 (mesmo dia, segunda sprint do redesign) concluída sem reabrir o pedido, conforme essa decisão — CTO só registra a contagem, não volta a propor a cada sprint |

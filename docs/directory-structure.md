...
│   │   │   └── transactionEdit.ts  # EditableTransaction (forma mínima compartilhada entre CategorizedTransaction/PluggyTransaction) + descricaoExibida (Sprint 10)
│   │   ├── api/
...
│   │   │   └── TransactionEditCells.tsx  # DescriptionCell/CategorySelectCell/AssetSelectCell — extraídos de CategorizationReviewPage, reaproveitados em TransacoesPanel (Dashboard) e nos drill-downs de Ativos/Passivos (Sprint 10)
│   │   ├── hooks/
...
- Modernização visual/paginação da tabela de Categorização (hoje HTML puro, sem tokens do design system) — Sprint 11.

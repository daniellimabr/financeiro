...
Atualizado a cada mudança estrutural. Estado atual (fim da Sprint 30 — Categorias por usuário, Orçamento, Gestão de Categorias, remoção da Projeção):
...
│   │   │   ├── TransactionsTable.tsx  # tabela de transação unificada (Sprint 13) — substitui TransacoesPanel (DashboardsPage), o <table> hand-rolled de AssetDrilldown e o de LiabilityDrilldown; flags showCategoria/showAtivo (default true), colgroup .txn-table; +investimentoId/showInvestimento (default false) (Sprint 19)

...
│   │   │   └── router.py
│   │   ├── investimentos/          # CRUD Investimento + get_evolucao, isolado por user_id (Sprint 19, novo)
...
│   │   │   ├── investimentos.ts    # chamadas /investimentos/* — fetch/create/update/deleteInvestimento, fetchInvestimentoEvolucao (Sprint 19, novo)
